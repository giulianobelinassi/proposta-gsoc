...
resulted in a blog post about the patch \textit{Optimize sin(arctan(x))}.
...
am interested in for the subject of my masters thesis, I found a
...
This was way before the list of GSoC accepted organizations was made public.
...
\begin{itemize}
 \item{Week [1, 6] -- May 6 to June 14:} \\
...
Deliver the refactored version of \texttt{cgraph\_node::expand()} and
\texttt{expand\_all\_functions}, and the partial documentation
with regard to \texttt{GIMPLE}
 \item{Week [9, 11] -- July 1 to 19:} \\
Continue documentating and refactoring the \texttt{GIMPLE} passes.
